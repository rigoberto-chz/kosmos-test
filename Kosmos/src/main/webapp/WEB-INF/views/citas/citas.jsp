...
<html>
  <head>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/citas/citas.css" rel="stylesheet" type="text/css"/>
  </head>
  <body>
    <div class="container">
      ...
      <table class="table">
        ...
        <tbody>
          <c:forEach items="${lstCitas}" var="cita">
            <c:url var="deleteLink" value="./cancelarCita">
              <c:param name="idCita" value="${cita.idCita}" />
            </c:url>
            <tr>
              ...
              <td class="text-center">
                <a href="${deleteLink}" onclick="if (!(confirm('Are you sure you want to delete this appointment?'))) return false;" class="btn btn-link">
      ...
      <hr/>
      <a type="button" class="btn btn-primary" href="${pageContext.request.contextPath}/citas">
      ...
      <a class="btn btn-success" href="${pageContext.request.contextPath}/crearCita">
      ...
      <a class="btn btn-success" href="${pageContext.request.contextPath}/buscarCitas">
